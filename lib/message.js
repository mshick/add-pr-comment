...
export async function getMessage({ messageInput, messagePath, messageCancelled, messageSkipped, messageFailure, messageSuccess, preformatted, status, }) {
    let message;
...
export async function getMessageFromPath(searchPath) {
    let message = '';
...
export function addMessageHeader(messageId, message) {
    return `${messageId}\n\n${message}`;
}
export function removeMessageHeader(message) {
...
export function findAndReplaceInMessage(find, replace, original) {
